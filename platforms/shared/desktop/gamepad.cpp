...
static bool gamepad_shortcut_prev[GT_MAX_GAMEPADS][config_HotkeyIndex_COUNT] = { };
...
void gamepad_add(void)
{
    ...
    bool player_connected[GT_MAX_GAMEPADS] = { };
    ...
    for (int i = 0; i < gamepad_count; i++)
    {
        ...
        for (int p = 0; p < GT_MAX_GAMEPADS; p++)
        {
...
{
    if (slot < 0 || slot >= GT_MAX_GAMEPADS)
        return;
