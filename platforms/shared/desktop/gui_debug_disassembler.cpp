...
static void disassembler_menu(void)
{
    ...
    if (ImGui::BeginMenu("View"))
    {
        ...
        {
            static const char* syntax_names[GG_Disassembler_Syntax_Count] = { GT_TITLE, "PCEAS", "WLA-DX" };
...
void gui_debug_window_call_stack(void)
{
    ...
    if (ImGui::BeginTable("call_stack", 3, flags))
    {
        ...
        while (!temp_stack.empty())
        {
            ...
            GG_Disassembler_Record* record = memory->GetDisassemblerRecord(entry.dest, entry.bank);
