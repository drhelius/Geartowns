...
EXTERN bool sound_queue_start(int sample_rate, int channel_count, int buffer_size = GT_AUDIO_QUEUE_SIZE, int buffer_count = 3);
...
EXTERN float sound_queue_get_target_latency_ms(void);
