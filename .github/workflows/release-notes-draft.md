...
Detect the newest Geartowns draft release created by the `Build and Release` workflow and replace its generated release notes with concise notes that match the recent manual release style.
...
This is an automated release-notes draft generated by [Release Notes Draft](https://github.com/${{ github.repository }}/actions/workflows/release-notes-draft.lock.yml)
```
...
End the complete release notes with the linked automation sentence shown in the Phase 4 example.
...
Keep the notes short, factual, and in the established emulator release style. Use only the linked automation sentence as the sign-off. Do not add a long generated summary, internal analysis, or human-like sign-off.