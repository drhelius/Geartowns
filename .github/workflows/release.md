---
name: Release
description: Bump the patch version and create a release tag for Geartowns.
on:
  workflow_dispatch:
permissions:
  contents: read
...
Create a new release for Geartowns by bumping the patch version, committing, and tagging, following the established release process. Do this autonomously: nobody provides any input when dispatching this workflow. If anything is inconsistent or unexpected, stop and fail without making changes.
