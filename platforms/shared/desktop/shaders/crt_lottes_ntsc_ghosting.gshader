; CRT Lottes + NTSC + Ghosting preset for Geartowns.
; Combines the Geartowns NTSC color artifact pass, CRT Lottes, and feedback ghosting.
; Includes the public domain CRT styled scan-line shader by Timothy Lottes.

[Preset]
Name=CRT Lottes + NTSC + Ghosting
Passes=3
