...
#if defined(GT_DEBUG)
#define WINDOW_TITLE GT_TITLE " " GT_VERSION " (DEBUG)"
#else
#define WINDOW_TITLE GT_TITLE " " GT_VERSION
#endif
...
{
    Log("\n%s", GT_TITLE_ASCII);
    Log("%s %s Desktop App", GT_TITLE, GT_VERSION);
