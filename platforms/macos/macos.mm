...
@interface GeartownsApplicationDelegate : NSObject <NSApplicationDelegate>
{
    id m_delegate;
    NSMenu* m_dock_menu;
}
...
@implementation GeartownsApplicationDelegate
...
- (void)launchNewInstance:(id)sender
{
    ...
    {
        if (error)
            NSLog(@"Failed to launch new Geartowns window: %@", error);
    }];
}
...
static GeartownsApplicationDelegate* geartowns_application_delegate = nil;
...
{
    if (geartowns_application_delegate ||
    ...
    geartowns_application_delegate =
        [[GeartownsApplicationDelegate alloc] initWithDelegate:delegate];
    [NSApp setDelegate:geartowns_application_delegate];
}
...
extern "C" void macos_remove_dock_menu(void)
{
    ...
    if ([NSApp delegate] == geartowns_application_delegate)
        [NSApp setDelegate:[geartowns_application_delegate originalDelegate]];

    [geartowns_application_delegate release];
    geartowns_application_delegate = nil;
}

extern "C" void macos_launch_new_instance(void)
{
    if (geartowns_application_delegate)
        [geartowns_application_delegate launchNewInstance:nil];
}
