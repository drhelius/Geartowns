...
void gui_popup_modal_about(void)
{
    if (ImGui::BeginPopupModal("About " GT_TITLE, NULL, ImGuiWindowFlags_AlwaysAutoResize))
    {
        ...
        ImGui::TextLinkOpenURL("https://github.com/drhelius/geartowns");
        ImGui::Text(" "); ImGui::SameLine();
        ...
        if (ImGui::BeginTabBar("##Tabs", ImGuiTabBarFlags_None))
        {
            if (ImGui::BeginTabItem("Build Info"))
            {
                ...
                #endif
                #if defined(GT_DEBUG)
                add_build_info("define: GT_DEBUG\n");
                #endif
                ...
                add_build_info("define: GT_LITTLE_ENDIAN");
                #endif
                #if defined(GT_BIG_ENDIAN)
                add_build_info("define: GT_BIG_ENDIAN");
                #endif
...
void gui_show_info(void)
{
    ...
    ImGui::Begin("Media Info", &config_emulator.show_info, ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoResize);
